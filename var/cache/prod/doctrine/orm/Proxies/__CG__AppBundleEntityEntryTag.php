 ...
 */
class EntryTag extends \AppBundle\Entity\EntryTag implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\EntryTag' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\EntryTag' . "\0" . 'entry', '' . "\0" . 'AppBundle\\Entity\\EntryTag' . "\0" . 'tag'];
        }
